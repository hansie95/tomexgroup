...
const subsidiaries = [
  ...
  },
  {
    ...
    image: '/divisions/tomexgroup_division_med.jpg',
    gradient: 'bg-gradient-to-t from-tomex-dark-teal/100 via-tomex-dark-teal/80 to-transparent',
    icon: Stethoscope,
    route: '/sectors/med',
  ...
  },
  {
    ...
    image: '/divisions/tomexgroup_division_sport.jpg',
    gradient: 'bg-gradient-to-t from-tomex-dark-teal/100 via-tomex-dark-teal/80 to-transparent',
    icon: Dumbbell,
    route: '/sectors/sport',
  ...
  },
  {
    ...
    image: '/divisions/tomexgroup_division_tech.jpg',
    gradient: 'bg-gradient-to-t from-tomex-dark-teal/100 via-tomex-dark-teal/80 to-transparent',
    icon: Monitor,
    route: '/sectors/tech',
  ...
  },
  {
    ...
    image: '/divisions/tomexgroup_division_szallodapro.jpg',
    gradient: 'bg-gradient-to-t from-tomex-dark-teal/100 via-tomex-dark-teal/80 to-transparent',
    icon: Hotel,
    route: '/sectors/hotel',
  ...
  },
  {
    ...
    image: '/divisions/tomexgroup_division_group.jpg',
    gradient: 'bg-gradient-to-t from-tomex-dark-teal/100 via-tomex-dark-teal/80 to-transparent',
    icon: Component,
    route: '/',
